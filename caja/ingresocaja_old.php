<?php
//Include Common Files @1-D93FBF89
define("RelativePath", "..");
define("PathToCurrentPage", "/caja/");
define("FileName", "ingresocaja_old.php");
...
//Include Page implementation @2-CE3F29BA
include_once(RelativePath . "/caja/menucaja.php");
...
//Class_Initialize Event @20-E0AA1E5A
...
//DataSourceClass_Initialize Event @20-F8C05A06
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "ingresocaja_old.html";
$BlockToParse = "main";
...
//Include events file @1-D610EEB0
include_once("./ingresocaja_old_events.php");
...
// Controls
$menucaja = & new clsmenucaja("", "menucaja", $MainPage);
$menucaja->Initialize();
...
//Execute Components @1-3B894BA5
$menucaja->Operations();
$movimientoscaja->Operation();
$buscafecha->Operation();
//End Execute Components

//Go to destination page @1-F254C6AB
if($Redirect)
{
    $CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
    $DBConnection1->close();
    header("Location: " . $Redirect);
    $menucaja->Class_Terminate();
    unset($menucaja);
