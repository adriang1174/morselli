<?php
//Include Common Files @1-04B61537
define("RelativePath", "..");
define("PathToCurrentPage", "/caja/");
define("FileName", "movimientocaja.php");
...
//Class_Initialize Event @3-F602DE44
...
"FROM codigosgastos {SQL_Where} Order by descripcion";
            ...
            $this->tipomov = & new clsControl(ccsListBox, "tipomov", "tipomov", ccsText, "", CCGetRequestParam("tipomov", $Method, NULL), $this);
            $this->tipomov->DSType = dsListOfValues;
            $this->tipomov->Values = array(array("C", "Crédito"), array("D", "Débito"));
            $this->gasto = & new clsControl(ccsTextBox, "gasto", "gasto", ccsText, "", CCGetRequestParam("gasto", $Method, NULL), $this);
        }
    }
...
//Validate Method @3-C589AC72
    function Validate()
    {
        ...
        $Validation = ($this->gasto->Validate() && $Validation);
        ...
        $Validation =  $Validation && ($this->gasto->Errors->Count() == 0);
        return (($this->Errors->Count() == 0) && $Validation);
    }
//End Validate Method

//CheckErrors Method @3-E6C16BBC
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->gasto->Errors->Count());
...
//InsertRow Method @3-A19405D9
    function InsertRow()
    {
        ...
        $this->DataSource->gasto->SetValue($this->gasto->GetValue(true));
...
//Show Method @3-2DE6BC31
    function Show()
    {
        ...
        if($this->EditMode) {
            ...
            if($this->DataSource->Errors->Count() == 0 && $this->DataSource->next_record()) {
                ...
                if(!$this->FormSubmitted){
                    ...
                    $this->gasto->SetValue($this->DataSource->gasto->GetValue());
                }
            } else {
                $this->EditMode = false;
            }
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->gasto->Errors->ToString());
...
//DataSource Variables @3-03DC98FF
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @3-B974B37D
    function clsmovimientoscajaDataSource(& $Parent)
    {
        ...
        $this->gasto = new clsField("gasto", ccsText, "");
        ...
        $this->InsertFields["gasto"] = array("Name" => "gasto", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        ...
        $this->UpdateFields["gasto"] = array("Name" => "gasto", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
    }
...
//SetValues Method @3-1F82D36C
    function SetValues()
    {
        ...
        $this->tipomov->SetDBValue($this->f("tipomovimiento"));
        $this->gasto->SetDBValue($this->f("gasto"));
    }
//End SetValues Method

//Insert Method @3-3B424D91
    function Insert()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        ...
        $this->InsertFields["tipomovimiento"]["Value"] = $this->tipomov->GetDBValue(true);
        $this->InsertFields["gasto"]["Value"] = $this->gasto->GetDBValue(true);
...
//Update Method @3-456BEAF7
    function Update()
    {
        ...
        $this->UpdateFields["tipomovimiento"]["Value"] = $this->tipomov->GetDBValue(true);
        $this->UpdateFields["gasto"]["Value"] = $this->gasto->GetDBValue(true);
...
//Class_Initialize Event @20-A157A677
    function clsGridmovimientoscaja1($RelativePath, & $Parent)
    {
        ...
        $this->gasto = & new clsControl(ccsLabel, "gasto", "gasto", ccsText, "", CCGetRequestParam("gasto", ccsGet, NULL), $this);
        $this->idhipoteca = & new clsControl(ccsHidden, "idhipoteca", "idhipoteca", ccsText, "", CCGetRequestParam("idhipoteca", ccsGet, NULL), $this);
        $this->idalquiler = & new clsControl(ccsLabel, "idalquiler", "idalquiler", ccsText, "", CCGetRequestParam("idalquiler", ccsGet, NULL), $this);
...
//Show Method @20-EF429711
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["gasto"] = $this->gasto->Visible;
...
//GetErrors Method @20-28573755
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->gasto->Errors->ToString());
...
//DataSource Variables @20-C83EB2AD
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @20-D97DA2EB
...
//Open Method @20-FCB2EAE3
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (SELECT idmovimiento,m.idmoneda,mo.simbolo,c.idcuota,c.idhipoteca,c.idalquiler,m.idcodgasto,tipomovimiento,fecha,m.importe,\n" .
        ...
        $this->SQL = "SELECT TOP {SqlParam_endRecord} idmovimiento,m.idmoneda,mo.simbolo,c.idcuota,c.idhipoteca,c.idalquiler,m.idcodgasto,tipomovimiento,fecha,m.importe,\n" .
        "case when c.idcuota is not null then\n" .
        "		t.descripcion\n" .
        "else\n" .
        "		--case when tipomovimiento = 'C' then\n" .
...
//Class_Initialize Event @36-F35EB2C2
...
//Operation Method @36-BE2C7094
    function Operation()
    {
        ...
        $Redirect = "movimientocaja.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "movimientocaja.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
class clsGridmovimientoscaja2 { //movimientoscaja2 class @49-69ED4459

//Variables @49-AC1EDBB9
...
//Class_Initialize Event @49-CC60EB9B
...
} //End movimientoscaja2 Class @49-FCB6E20C

class clsmovimientoscaja2DataSource extends clsDBConnection1 {  //movimientoscaja2DataSource Class @49-487D03FE

//DataSource Variables @49-E95C6F7E
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @49-37DFE152
...
} //End movimientoscaja2DataSource Class @49-FCB6E20C



//Initialize Page @1-7132A9E3
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "movimientocaja.html";
$BlockToParse = "main";
...
//Include events file @1-329C5102
include_once("./movimientocaja_events.php");
...
//Go to destination page @1-969EC1DF
if($Redirect)
{
