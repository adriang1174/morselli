...
//DEL  // -------------------------
//DEL  $movimientoscaja->tipomovimiento->SetValue('D');
//DEL  // -------------------------
...
//if($movimientoscaja1->idalquiler->GetValue()!= '' and $movimientoscaja1->idhipoteca->GetValue() == '')
//{
//	$desc = $movimientoscaja1->descripcion->GetValue();
//	$movimientoscaja1->descripcion->SetValue($desc. 'Alquiler '. );
...
//Page_BeforeInitialize @1-D3AF3B82
function Page_BeforeInitialize(& $sender)
{
    $Page_BeforeInitialize = true;
    $Component = & $sender;
    $Container = & CCGetParentContainer($sender);
    global $movimientocaja; //Compatibility
