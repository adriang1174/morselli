<?php
class clsGridmenuincluibleJSMenu { //JSMenu class @2-BD90DBD8
...
//Class_Initialize Event @2-AFFF968B
    function clsGridmenuincluibleJSMenu($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        ...
        $this->DataSource = new clsmenuincluibleJSMenuDataSource($this);
...
class clsmenuincluibleJSMenuDataSource extends clsDBConnection1 {  //JSMenuDataSource Class @2-2EE91420
...
//DataSourceClass_Initialize Event @2-1F9341F4
    function clsmenuincluibleJSMenuDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Grid JSMenu";
        $this->Initialize();
...
class clsmenuincluible { //menuincluible class @1-91341FB7
...
//Class_Initialize Event @1-048BD577
    function clsmenuincluible($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "menuincluible.php";
        $this->Redirect = "";
        $this->TemplateFileName = "menuincluible.html";
...
//BindEvents Method @1-13B76FBE
    function BindEvents()
    {
        $this->JSMenu->Menu_Caption->CCSEvents["BeforeShow"] = "menuincluible_JSMenu_Menu_Caption_BeforeShow";
        $this->JSMenu->Menu_Url->CCSEvents["BeforeShow"] = "menuincluible_JSMenu_Menu_Url_BeforeShow";
...
//Initialize Method @1-0B60A065
    function Initialize()
    {
        ...
        // Create Components
        $this->JSMenu = & new clsGridmenuincluibleJSMenu($this->RelativePath, $this);
...
} //End menuincluible Class @1-FCB6E20C

//Include Event File @1-C1B5025D
include_once(RelativePath . "/menuincluible_events.php");
