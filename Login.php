...
//Class_Initialize Event @2-F4227D41
...
//Operation Method @2-514F46F2
    function Operation()
    {
        ...
        $Redirect = "paginaprincipal/menuprincipal.php";
        if($this->Validate()) {
...
//Go to destination page @1-E32F0A6E
if($Redirect)
{
