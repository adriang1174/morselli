<?php
//Include Common Files @1-6AF61F05
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "liquidacion_liquidacion_Grid2_s_nombre_PTAutocomplete1.php");
...
//Class_Initialize Event @2-0094079D
...
//Show Method @2-EB184979
    function Show()
    {
        ...
        $this->DataSource->Parameters["posts_nombre"] = CCGetFromPost("s_nombre", NULL);
...
//DataSource Variables @2-395D8BE4
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-93254BC8
...
//Prepare Method @2-65D4012D
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "posts_nombre", ccsText, "", "", $this->Parameters["posts_nombre"], "", false);
        $this->wp->Criterion[1] = $this->wp->Operation(opBeginsWith, "nombre", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method

//Open Method @2-9048408C
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM fichas";
        $this->SQL = "SELECT TOP {SqlParam_endRecord} nombre \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "liquidacion_liquidacion_Grid2_s_nombre_PTAutocomplete1.html";
$BlockToParse = "main";
