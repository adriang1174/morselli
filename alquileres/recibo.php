...
$idcuota = $_REQUEST['idalquiler']; //Solo se utiliza para los impuestos
$acuerdo = $_REQUEST['acuerdo'];
if (!is_numeric($acuerdo))
	$acuerdo = 0;
...
$sql = "EXEC sp_verifica_cuotas_pagadas '".$cuotas."'";
$conn->query($sql); 
$conn->next_record();
...
//
// Ingresamos los impuestos 
//

if (CCGetFromPost('impuestos1','')<> '')
{
	$sql = "insert into impuestosalquileridcuota values(".CCGetFromPost('idimpuestos1',0).",".$idalquiler.",".$cuotas.",'".CCGetFromPost('impuestos1',0)."')";
	$conn->query($sql);
}
if (CCGetFromPost('impuestos2','')<> '')
{
	$sql = "insert into impuestosalquileridcuota values(".CCGetFromPost('idimpuestos2',0).",".$idalquiler.",".$cuotas.",'".CCGetFromPost('impuestos2',0)."')";
	$conn->query($sql);
}
if (CCGetFromPost('impuestos3','')<> '')
{
	$sql = "insert into impuestosalquileridcuota values(".CCGetFromPost('idimpuestos3',0).",".$idalquiler.",".$cuotas.",'".CCGetFromPost('impuestos3',0)."')";
	$conn->query($sql);
}
if (CCGetFromPost('impuestos4','')<> '')
{
	$sql = "insert into impuestosalquileridcuota values(".CCGetFromPost('idimpuestos4',0).",".$idalquiler.",".$cuotas.",'".CCGetFromPost('impuestos4',0)."')";
	$conn->query($sql);
}
if (CCGetFromPost('impuestos5','')<> '')
{
	$sql = "insert into impuestosalquileridcuota values(".CCGetFromPost('idimpuestos5',0).",".$idalquiler.",".$cuotas.",'".CCGetFromPost('impuestos5',0)."')";
	$conn->query($sql);
}
if (CCGetFromPost('impuestos6','')<> '')
{
	$sql = "insert into impuestosalquileridcuota values(".CCGetFromPost('idimpuestos6',0).",".$idalquiler.",".$cuotas.",'".CCGetFromPost('impuestos6',0)."')";
	$conn->query($sql);
}
if (CCGetFromPost('impuestos7','')<> '')
{
	$sql = "insert into impuestosalquileridcuota values(".CCGetFromPost('idimpuestos7',0).",".$idalquiler.",".$cuotas.",'".CCGetFromPost('impuestos7',0)."')";
	$conn->query($sql);
}
if (CCGetFromPost('impuestos8','')<> '')
{
	$sql = "insert into impuestosalquileridcuota values(".CCGetFromPost('idimpuestos8',0).",".$idalquiler.",".$cuotas.",'".CCGetFromPost('impuestos8',0)."')";
	$conn->query($sql);
}
if (CCGetFromPost('impuestos9','')<> '')
{
	$sql = "insert into impuestosalquileridcuota values(".CCGetFromPost('idimpuestos9',0).",".$idalquiler.",".$cuotas.",'".CCGetFromPost('impuestos9',0)."')";
	$conn->query($sql);
}
if (CCGetFromPost('impuestos10','')<> '')
{
	$sql = "insert into impuestosalquileridcuota values(".CCGetFromPost('idimpuestos10',0).",".$idalquiler.",".$cuotas.",'".CCGetFromPost('impuestos10',0)."')";
	$conn->query($sql);
}
$sql = '';
//
...
$pdf=new PDF();
//$pdf->AliasNbPages();
$detalle1 = substr($_REQUEST['detalle1'],0,33);
$detalle2 = substr($_REQUEST['detalle2'],0,33);
$detalle3 = substr($_REQUEST['detalle3'],0,33);
$detalle4 = substr($_REQUEST['detalle4'],0,33);
$detalle5 = substr($_REQUEST['detalle5'],0,33);
$detalle6 = substr($_REQUEST['detalle6'],0,33);
$detalle7 = substr($_REQUEST['detalle7'],0,33);
$detalle8 = substr($_REQUEST['detalle8'],0,33);
$detalle9 = substr($_REQUEST['detalle9'],0,33);
$detalle10 = substr($_REQUEST['detalle10'],0,33);

$otros1 = CCGetFromPost('otros1','0');
$otros1 = ($otros1 == '') ? 0:$otros1;
$otros2 = CCGetFromPost('otros2','0');
$otros2 = ($otros2 == '') ? 0:$otros2;
$otros3 = CCGetFromPost('otros3','0');
$otros3 = ($otros3 == '') ? 0:$otros3;
$otros4 = CCGetFromPost('otros4','0');
$otros4 = ($otros4 == '') ? 0:$otros4;
$otros5 = CCGetFromPost('otros5','0');
$otros5 = ($otros5 == '') ? 0:$otros5;
$otros6 = CCGetFromPost('otros6','0');
$otros6 = ($otros6 == '') ? 0:$otros6;
$otros7 = CCGetFromPost('otros7','0');
$otros7 = ($otros7 == '') ? 0:$otros7;
$otros8 = CCGetFromPost('otros8','0');
$otros8 = ($otros8 == '') ? 0:$otros8;
$otros9 = CCGetFromPost('otros9','0');
$otros9 = ($otros9 == '') ? 0:$otros9;
$otros10 = CCGetFromPost('otros10','0');
...
//
// Por si existe acuerdo
//
$sql = "EXEC sp_verifica_acuerdo '".$cuotas."', ".$acuerdo;
$conn->query($sql); 
$conn->next_record();
$acuerdo = $conn->f('acuerdo');

if($acuerdo > 0 )
	$observaciones .= "Por acuerdo entre las partes este mes aboné $".$acuerdo. ". No implica compromiso futuro";
...
/*
   ...
   if ($otros > 0 )
   {
   		$detalle1 = $_REQUEST['detalle1'];
		$detalle2 = $_REQUEST['detalle2'];
	}
	else
	{
		$detalle1 = '';
...
//	$pdf->SetXY($pdf->GetX()-175,$pdf->GetY());
	...
	$pdf->SetFont('Arial','',8);
	$pdf->Cell(80,10,substr($direccion_inquilino,0,50)); //$domicilio_inquilino
	$pdf->SetFont('Arial','',10);
	$pdf->Cell(17,10,'Localidad: ');
	$pdf->SetFont('Arial','',8);
	$pdf->Cell(30,10,substr($localidad_inquilino,0,20)); //$domicilio
	$pdf->SetFont('Arial','',10);
	$pdf->Ln(5);
	$pdf->SetXY($pdf->GetX()+20,$pdf->GetY());
	$pdf->Cell(5,10,'');
	...
	$pdf->Cell(115,10,$direccion); //$domicilio_propiedad
