<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\alquileres" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="SandBeach" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		<Grid id="2" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="10" connection="Connection1" dataSource="fichas, propiedades, alquileres, fichasalquileres" activeCollection="TableParameters" name="fichas_fichaspropiedades1" pageSizeLimit="100" wizardCaption=" Fichas,fichaspropiedades,propiedades Lista de" wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="False" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="No hay registros">
			<Components>
...
<TableParameter id="24" conditionType="Parameter" useIsNull="False" field="fichas.idficha" parameterSource="s_fichas_idficha" dataType="Integer" logicOperator="And" searchConditionType="Equal" parameterType="URL" orderNumber="1" leftBrackets="1" rightBrackets="0"/>
				...
				<TableParameter id="26" conditionType="Parameter" useIsNull="False" field="propiedades.direccion" parameterSource="s_propiedades_direccion" dataType="Text" logicOperator="And" searchConditionType="Contains" parameterType="URL" orderNumber="3" leftBrackets="0" rightBrackets="1"/>
			</TableParameters>
			<JoinTables>
				...
				<JoinTable id="41" tableName="alquileres" schemaName="dbo" posLeft="337" posTop="8" posWidth="158" posHeight="180"/>
				<JoinTable id="46" tableName="fichasalquileres" schemaName="dbo" posLeft="175" posTop="10" posWidth="95" posHeight="120"/>
			</JoinTables>
			<JoinLinks>
				<JoinTable2 id="45" tableLeft="propiedades" tableRight="alquileres" fieldLeft="propiedades.idpropiedad" fieldRight="alquileres.idpropiedad" joinType="inner" conditionType="Equal"/>
				<JoinTable2 id="47" tableLeft="alquileres" tableRight="fichasalquileres" fieldLeft="alquileres.idalquiler" fieldRight="fichasalquileres.idalquiler" joinType="inner" conditionType="Equal"/>
				<JoinTable2 id="48" tableLeft="fichas" tableRight="fichasalquileres" fieldLeft="fichas.idficha" fieldRight="fichasalquileres.idficha" joinType="inner" conditionType="Equal"/>
			</JoinLinks>
			<Fields>
				...
				<Field id="49" tableName="fichasalquileres" fieldName="fichasalquileres.*"/>
			</Fields>
			<SPParameters/>
			<SQLParameters/>
			<SecurityGroups/>
