<?php
//Include Common Files @1-16FC1248
define("RelativePath", "..");
define("PathToCurrentPage", "/hipotecas/");
define("FileName", "avisoliq.php");
...
//Class_Initialize Event @3-30E44245
    function clsGridGrid1($RelativePath, & $Parent)
    {
        ...
        $this->avisa = & new clsControl(ccsCheckBox, "avisa", "avisa", ccsBoolean, $CCSLocales->GetFormatInfo("BooleanFormat"), CCGetRequestParam("avisa", ccsGet, NULL), $this);
        $this->avisa->CheckedValue = true;
        $this->avisa->UncheckedValue = false;
        ...
        $this->Marcar = & new clsButton("Marcar", ccsGet, $this);
    }
...
//Show Method @3-E4E6D88B
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["avisa"] = $this->avisa->Visible;
...
//GetErrors Method @3-7CF4B352
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->avisa->Errors->ToString());
...
//DataSource Variables @3-1AA68FA6
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @3-B92A23DF
...
//Open Method @3-4A4DBBFB
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*) FROM (select f.idficha,f.nombre,h.idhipoteca,h.montohipoteca, m.simbolo, c.idcuota,c.ano,c.mes,c.importe,c.fechapago\n" .
        "	from cuotas c\n" .
        ...
        "and fechaaviso is null\n" .
        "and idtipocuota in(2,4)) cnt";
        $this->SQL = "select f.idficha,f.nombre,h.idhipoteca,h.montohipoteca, m.simbolo, c.idcuota,c.ano,c.mes,c.importe,c.fechapago\n" .
        "	from cuotas c\n" .
        "	join hipotecas h on(c.idhipoteca = h.idhipoteca)\n" .
        "	join fichashipotecas fh on(h.idhipoteca = c.idhipoteca)\n" .
        "	join fichas f on(fh.idficha = f.idficha)\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "avisoliq.html";
$BlockToParse = "main";
