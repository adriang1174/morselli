<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\hipotecas" secured="True" urlType="Relative" isIncluded="False" SSLAccess="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="SandBeach" wizardThemeVersion="3.0" needGeneration="0" isService="False" pasteActions="pasteActions">
	<Components>
		...
		<Record id="2" sourceType="Table" urlType="Relative" secured="False" allowInsert="True" allowUpdate="True" allowDelete="True" validateData="True" preserveParameters="GET" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" connection="Connection1" name="hipotecas" dataSource="hipotecas" errorSummator="Error" wizardCaption="Agregar/Editar Hipotecas " wizardFormMethod="post" PathID="hipotecas" pasteAsReplace="pasteAsReplace" pasteActions="pasteActions" activeCollection="TableParameters">
			<Components>
				...
				<TextBox id="10" visible="Yes" fieldSourceType="DBColumn" dataType="Date" name="fechainicio" fieldSource="fechainicio" required="False" caption="Fechainicio" wizardCaption="Fechainicio" wizardSize="10" wizardMaxLength="100" wizardIsPassword="False" PathID="hipotecasfechainicio" format="dd/mm/yyyy" DBFormat="yyyy-mm-dd HH:nn:ss.S">
					<Components/>
					<Events>
						<Event name="BeforeShow" type="Server">
							<Actions>
				...
				<TextBox id="12" visible="Yes" fieldSourceType="DBColumn" dataType="Date" name="fechafin" fieldSource="fechafin" required="False" caption="Fechafin" wizardCaption="Fechafin" wizardSize="10" wizardMaxLength="100" wizardIsPassword="False" PathID="hipotecasfechafin" format="dd/mm/yyyy" DBFormat="yyyy-mm-dd HH:nn:ss.S">
					<Components/>
					<Events>
						<Event name="BeforeShow" type="Server">
							<Actions>
				...
				<TextBox id="85" visible="Yes" fieldSourceType="DBColumn" dataType="Integer" name="idhipoteca" PathID="hipotecasidhipoteca" fieldSource="idhipoteca">
					<Components/>
					<Events>
						<Event name="BeforeShow" type="Server">
							<Actions>
				...
				<TextBox id="91" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="honorario" PathID="hipotecashonorario" fieldSource="honorario" defaultValue="0.3" required="True">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</TextBox>
				<TextBox id="92" visible="Yes" fieldSourceType="DBColumn" dataType="Text" name="liqhip" PathID="hipotecasliqhip" fieldSource="liqhip" defaultValue="0.2" required="True">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<TableParameters>
				<TableParameter id="20" conditionType="Parameter" useIsNull="False" field="idpropiedad" dataType="Integer" searchConditionType="Equal" parameterType="URL" logicOperator="And" parameterSource="idpropiedad"/>
				<TableParameter id="93" conditionType="Parameter" useIsNull="False" field="idhipoteca" dataType="Integer" searchConditionType="Equal" parameterType="URL" logicOperator="And" parameterSource="idhipoteca"/>
</TableParameters>
			<SPParameters/>
			<SQLParameters/>
			<JoinTables>
		...
		<EditableGrid id="22" urlType="Relative" secured="False" emptyRows="1" allowInsert="True" allowUpdate="True" allowDelete="True" validateData="True" preserveParameters="GET" sourceType="Table" defaultPageSize="10" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" connection="Connection1" dataSource="fichashipotecas" activeCollection="UFormElements" name="fichashipotecas" pageSizeLimit="100" wizardCaption=" Fichashipotecas Lista de" wizardGridType="Tabular" wizardAltRecord="False" wizardRecordSeparator="False" wizardNoRecords="No hay registros" PathID="fichashipotecas" deleteControl="CheckBox_Delete" customInsertType="Table" activeTableType="fichashipotecas" customInsert="fichashipotecas" customUpdateType="Table" customUpdate="fichashipotecas">
			<Components>
				...
				<TextBox id="30" visible="Yes" fieldSourceType="DBColumn" dataType="Integer" name="monto" fieldSource="monto" required="False" caption="Monto" wizardCaption="Porcentajehip" wizardSize="20" wizardMaxLength="20" wizardIsPassword="False" wizardUseTemplateBlock="False" PathID="fichashipotecasmonto">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Hidden id="90" fieldSourceType="DBColumn" dataType="Float" name="suma" PathID="fichashipotecassuma">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<IFormElements>
				...
				<CustomParameter id="60" field="monto" dataType="Integer" parameterType="Control" parameterSource="monto" omitIfEmpty="True"/>
			...
			<UFormElements>
				...
				<CustomParameter id="66" field="monto" dataType="Integer" parameterType="Control" parameterSource="monto" omitIfEmpty="True"/>
			</UFormElements>
			<DSPParameters/>
			<DSQLParameters/>
			<DConditions/>
		...
		<Grid id="36" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="10" connection="Connection1" dataSource="fichashipotecas" name="fichashipotecasRO" pageSizeLimit="100" wizardCaption=" Fichashipotecas Lista de" wizardGridType="Tabular" wizardAllowInsert="False" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="No hay registros" activeCollection="TableParameters">
			<Components>
				...
				<Label id="38" fieldSourceType="DBColumn" dataType="Integer" html="False" name="monto" fieldSource="monto" wizardCaption="Porcentajehip" wizardSize="20" wizardMaxLength="20" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAlign="right" wizardAddNbsp="True" PathID="fichashipotecasROmonto">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<TableParameters>
				<TableParameter id="74" conditionType="Parameter" useIsNull="False" field="idhipoteca" dataType="Integer" searchConditionType="Equal" parameterType="URL" logicOperator="And" parameterSource="idhipoteca"/>
			</TableParameters>
			<JoinTables>
				<JoinTable id="73" tableName="fichashipotecas" posLeft="10" posTop="10" posWidth="95" posHeight="136"/>
			</JoinTables>
			<JoinLinks/>
			<Fields/>
			<SPParameters/>
		...
		<Record id="67" sourceType="Table" urlType="Relative" secured="False" allowInsert="True" allowUpdate="False" allowDelete="False" validateData="True" preserveParameters="GET" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" name="generacuotas" actionPage="hipotecas_maint" errorSummator="Error" wizardFormMethod="post" PathID="generacuotas" connection="Connection1" returnPage="hipotecas_maint.ccp" parameterTypeListName="ParameterTypeList" activeCollection="ISPParameters" customInsertType="Procedure" customInsert="SP_GENERA_CUOTAS_HIPOTECA;1" dataSource="anohipoteca">
			<Components>
				<Button id="70" urlType="Relative" enableValidation="True" isDefault="False" name="Button_Insert" PathID="generacuotasButton_Insert" operation="Insert" wizardCaption="Agregar" returnPage="hipotecas_maint.ccp">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
		...
		<Grid id="76" secured="False" sourceType="Procedure" returnValueType="Number" defaultPageSize="10" connection="Connection1" resultSetType="parameter" dataSource="sp_deuda_hipoteca;1" name="deuda" pageSizeLimit="100" wizardCaption=" Grid1 Lista de" wizardGridType="Columnar" wizardAllowInsert="False" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="No hay registros">
			<Components>
				<Label id="77" fieldSourceType="DBColumn" dataType="Text" html="False" name="deuda" fieldSource="deuda" wizardCaption="Deuda" wizardSize="15" wizardMaxLength="15" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="deudadeuda">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="78" fieldSourceType="DBColumn" dataType="Text" html="False" name="liquidacionp" fieldSource="liquidacionp" wizardCaption="Liquidacionp" wizardSize="15" wizardMaxLength="15" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="deudaliquidacionp">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="80" fieldSourceType="DBColumn" dataType="Text" html="False" name="Label1" PathID="deudaLabel1">
					<Components/>
					<Events>
						<Event name="BeforeShow" type="Server">
							<Actions>
			...
			<Fields/>
			<SPParameters>
				<SPParameter id="83" parameterName="@RETURN_VALUE" parameterSource="RETURN_VALUE" parameterType="URL" direction="ReturnValue" dataType="Int" dataSize="0" scale="0" precision="10"/>
				<SPParameter id="84" parameterName="@idhipoteca" parameterSource="idhipoteca" parameterType="URL" direction="Input" dataType="Int" dataSize="0" scale="0" precision="10"/>
			</SPParameters>
			<SQLParameters/>
			<SecurityGroups/>
			<Attributes/>
	...
	<CodeFiles>
		<CodeFile id="Code" language="PHPTemplates" name="hipotecas_maint.php" forShow="True" url="hipotecas_maint.php" comment="//" codePage="windows-1252"/>
		<CodeFile id="Events" language="PHPTemplates" name="hipotecas_maint_events.php" forShow="False" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups>
