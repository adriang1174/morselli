<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\hipotecas" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="SandBeach" wizardThemeVersion="3.0" needGeneration="0" wizardSortingType="Extended">
	<Components>
		<Grid id="2" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="10" connection="Connection1" dataSource="fichas, propiedades, hipotecas, fichaspropiedades" activeCollection="TableParameters" name="fichas_fichaspropiedades1" pageSizeLimit="100" wizardCaption=" Fichas,fichaspropiedades,propiedades Lista de" wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="False" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="No hay registros" wizardAllowSorting="True">
			<Components>
				...
				<Link id="33" fieldSourceType="DBColumn" dataType="Text" html="False" name="nombre" fieldSource="nombre" wizardCaption="Nombre" wizardSize="50" wizardMaxLength="50" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="True" PathID="fichas_fichaspropiedades1nombre" visible="Yes" hrefType="Page" urlType="Relative" preserveParameters="GET" hrefSource="pagos.ccp">
					...
					<LinkParameters>
						...
						<LinkParameter id="44" sourceType="DataField" name="idhipoteca" source="hipotecas_idhipoteca"/>
					</LinkParameters>
				</Link>
				...
				<Label id="59" fieldSourceType="DBColumn" dataType="Text" html="False" name="hipoteca" PathID="fichas_fichaspropiedades1hipoteca" fieldSource="hipotecas_idhipoteca">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Sorter id="60" visible="True" name="Sorter1" wizardSortingType="SimpleDir" PathID="fichas_fichaspropiedades1Sorter1" wizardCaption="Sorter_contrato" column="hipotecas.idhipoteca">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<Events/>
			<TableParameters>
				<TableParameter id="24" conditionType="Parameter" useIsNull="False" field="fichas.idficha" parameterSource="s_fichas_idficha" dataType="Integer" logicOperator="And" searchConditionType="Equal" parameterType="URL" orderNumber="1" leftBrackets="0" rightBrackets="0"/>
				<TableParameter id="25" conditionType="Parameter" useIsNull="False" field="fichas.nombre" parameterSource="s_nombre" dataType="Text" logicOperator="And" searchConditionType="Contains" parameterType="URL" orderNumber="2" leftBrackets="0" rightBrackets="0"/>
				<TableParameter id="26" conditionType="Parameter" useIsNull="False" field="propiedades.direccion" parameterSource="s_propiedades_direccion" dataType="Text" logicOperator="And" searchConditionType="Contains" parameterType="URL" orderNumber="3" leftBrackets="0" rightBrackets="0"/>
			</TableParameters>
			<JoinTables>
				<JoinTable id="3" tableName="fichas" schemaName="dbo" posLeft="10" posTop="10" posWidth="144" posHeight="180"/>
				<JoinTable id="5" tableName="propiedades" schemaName="dbo" posLeft="493" posTop="28" posWidth="121" posHeight="180"/>
				<JoinTable id="54" tableName="hipotecas" schemaName="dbo" posLeft="711" posTop="45" posWidth="115" posHeight="180"/>
				<JoinTable id="61" tableName="fichaspropiedades" schemaName="dbo" posLeft="223" posTop="59" posWidth="108" posHeight="104"/>
			</JoinTables>
			<JoinLinks>
				<JoinTable2 id="65" tableLeft="propiedades" tableRight="hipotecas" fieldLeft="propiedades.idpropiedad" fieldRight="hipotecas.idpropiedad" joinType="inner" conditionType="Equal"/>
				<JoinTable2 id="66" tableLeft="fichas" tableRight="fichaspropiedades" fieldLeft="fichas.idficha" fieldRight="fichaspropiedades.idficha" joinType="inner" conditionType="Equal"/>
				<JoinTable2 id="67" tableLeft="propiedades" tableRight="fichaspropiedades" fieldLeft="propiedades.idpropiedad" fieldRight="fichaspropiedades.idpropiedad" joinType="inner" conditionType="Equal"/>
			</JoinLinks>
			<Fields>
				...
				<Field id="58" tableName="hipotecas" fieldName="hipotecas.idhipoteca" alias="hipotecas_idhipoteca"/>
				<Field id="64" tableName="fichaspropiedades" fieldName="fichaspropiedades.*"/>
			</Fields>
			<SPParameters/>
			<SQLParameters/>
			<SecurityGroups/>
	...
	<CodeFiles>
		<CodeFile id="Code" language="PHPTemplates" name="pagos_list.php" forShow="True" url="pagos_list.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
