<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\hipotecas" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="SandBeach" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		...
		<Grid id="3" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="10" connection="Connection1" dataSource="select f.idficha,f.nombre,h.idhipoteca,h.montohipoteca, m.simbolo, c.idcuota,c.ano,c.mes,c.importe,c.fechapago
	from cuotas c
...
and idtipocuota in(2,4)" name="Grid1" pageSizeLimit="100" wizardCaption=" Grid1 Lista de" wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="False" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="No hay registros">
			<Components>
				...
				<CheckBox id="21" visible="Yes" fieldSourceType="DBColumn" dataType="Boolean" name="avisa" PathID="Grid1avisa">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</CheckBox>
				<Button id="22" urlType="Relative" enableValidation="True" isDefault="False" name="Marcar" PathID="Grid1Marcar">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Button>
				<Label id="23" fieldSourceType="DBColumn" dataType="Date" html="False" name="fechapago" PathID="Grid1fechapago" fieldSource="fechapago" format="dd/mm/yyyy">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="24" fieldSourceType="DBColumn" dataType="Text" html="False" name="simbolo" PathID="Grid1simbolo" fieldSource="simbolo">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
	...
	<CodeFiles>
		<CodeFile id="Code" language="PHPTemplates" name="avisoliq.php" forShow="True" url="avisoliq.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
