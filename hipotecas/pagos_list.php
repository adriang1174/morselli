<?php
//Include Common Files @1-2AB0F779
define("RelativePath", "..");
...
//Class_Initialize Event @2-C3EB139B
    function clsGridfichas_fichaspropiedades1($RelativePath, & $Parent)
    {
        ...
        $this->hipoteca = & new clsControl(ccsLabel, "hipoteca", "hipoteca", ccsText, "", CCGetRequestParam("hipoteca", ccsGet, NULL), $this);
...
//Show Method @2-B0305D8B
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["hipoteca"] = $this->hipoteca->Visible;
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->nombre->Parameters = CCAddParam($this->nombre->Parameters, "idhipoteca", $this->DataSource->f("hipotecas_idhipoteca"));
                ...
                $this->hipoteca->SetValue($this->DataSource->hipoteca->GetValue());
...
//GetErrors Method @2-9BFAAE92
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->hipoteca->Errors->ToString());
...
//DataSource Variables @2-35C6A745
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-FBD00927
    function clsfichas_fichaspropiedades1DataSource(& $Parent)
    {
        ...
        $this->hipoteca = new clsField("hipoteca", ccsText, "");
        

    }
//End DataSourceClass_Initialize Event

//SetOrder Method @2-C013D7B8
    function SetOrder($SorterName, $SorterDirection)
    {
        ...
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, 
            ...
            "Sorter1" => array("hipotecas.idhipoteca", "")));
    }
//End SetOrder Method

//Prepare Method @2-2BEC398D
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urls_fichas_idficha", ccsInteger, "", "", $this->Parameters["urls_fichas_idficha"], "", false);
        $this->wp->AddParameter("2", "urls_nombre", ccsText, "", "", $this->Parameters["urls_nombre"], "", false);
        $this->wp->AddParameter("3", "urls_propiedades_direccion", ccsText, "", "", $this->Parameters["urls_propiedades_direccion"], "", false);
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "fichas.idficha", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsInteger),false);
        $this->wp->Criterion[2] = $this->wp->Operation(opContains, "fichas.nombre", $this->wp->GetDBValue("2"), $this->ToSQL($this->wp->GetDBValue("2"), ccsText),false);
        $this->wp->Criterion[3] = $this->wp->Operation(opContains, "propiedades.direccion", $this->wp->GetDBValue("3"), $this->ToSQL($this->wp->GetDBValue("3"), ccsText),false);
...
//Open Method @2-549CD961
    function Open()
    {
        ...
        "fichas.idficha AS fichas_idficha, propiedades.idpropiedad AS propiedades_idpropiedad, hipotecas.idhipoteca AS hipotecas_idhipoteca,\n\n" .
        "fichaspropiedades.* \n\n" .
        "FROM fichas INNER JOIN ((propiedades INNER JOIN hipotecas ON\n\n" .
        "propiedades.idpropiedad = hipotecas.idpropiedad) INNER JOIN fichaspropiedades ON\n\n" .
        "propiedades.idpropiedad = fichaspropiedades.idpropiedad) ON\n\n" .
...
//SetValues Method @2-E9403CD2
    function SetValues()
    {
        ...
        $this->hipoteca->SetDBValue($this->f("hipotecas_idhipoteca"));
    }
...
//Class_Initialize Event @19-44C8D839
...
//CheckErrors Method @19-531DD121
