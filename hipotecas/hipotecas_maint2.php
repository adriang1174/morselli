<?php
//Include Common Files @1-5139DE89
define("RelativePath", "..");
define("PathToCurrentPage", "/hipotecas/");
define("FileName", "hipotecas_maint2.php");
...
//Class_Initialize Event @2-809D5E5D
...
//DataSource Variables @2-BB3993E3
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-762BCFE0
...
//Class_Initialize Event @22-9D5A5376
...
//GetFormParameters Method @22-8F76CB93
...
//ValidateRow Method @22-56A6EEDC
...
//CheckInsert Method @22-781A120E
...
//DataSource Variables @22-EFDBBFD9
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @22-1A6E3E8D
...
//Class_Initialize Event @36-49F1B39B
...
//DataSource Variables @36-01DF67D8
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @36-B5F0BD54
...
//Operation Method @67-D87196FA
    function Operation()
    {
        ...
        $Redirect = "hipotecas_maint2.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->Validate()) {
            if($this->PressedButton == "Button_Insert") {
                $Redirect = "hipotecas_maint2.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
                if(!CCGetEvent($this->Button_Insert->CCSEvents, "OnClick", $this->Button_Insert) || !$this->InsertRow()) {
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "hipotecas_maint2.html";
$BlockToParse = "main";
...
//Include events file @1-8FA63741
include_once("./hipotecas_maint2_events.php");
...
//Go to destination page @1-AF6967EC
if($Redirect)
{
