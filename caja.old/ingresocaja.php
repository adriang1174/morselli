...
//Operation Method @36-FA0E5316
    function Operation()
    {
        ...
        $Redirect = "ingresocaja2.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "ingresocaja2.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Go to destination page @1-B9B3CEE0
if($Redirect)
{
