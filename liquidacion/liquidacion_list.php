<?php
//Include Common Files @1-13552F6E
define("RelativePath", "..");
define("PathToCurrentPage", "/liquidacion/");
define("FileName", "liquidacion_list.php");
...
//Class_Initialize Event @2-3D3F79E6
    function clsGridfichas_fichaspropiedades1($RelativePath, & $Parent)
    {
        ...
        $this->nombre->Page = "liquidacion.php";
...
//Open Method @2-FBE5E6F2
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM fichas INNER JOIN ((propiedades INNER JOIN alquileres ON\n\n" .
        "propiedades.idpropiedad = alquileres.idpropiedad) INNER JOIN fichaspropiedades ON\n\n" .
        ...
        "fichaspropiedades.*, alquileres.idpropiedad AS alquileres_idpropiedad \n\n" .
        "FROM fichas INNER JOIN ((propiedades INNER JOIN alquileres ON\n\n" .
        "propiedades.idpropiedad = alquileres.idpropiedad) INNER JOIN fichaspropiedades ON\n\n" .
        "propiedades.idpropiedad = fichaspropiedades.idpropiedad) ON\n\n" .
...
//Operation Method @19-B0107421
    function Operation()
    {
        ...
        $Redirect = "liquidacion_list.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "liquidacion_list.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "liquidacion_list.html";
$BlockToParse = "main";
