<?php
//Include Common Files @1-7F049F7B
define("RelativePath", "..");
define("PathToCurrentPage", "/alquileres/");
define("FileName", "liq_list.php");
...
//Operation Method @19-1224584B
    function Operation()
    {
        ...
        $Redirect = "liq_list.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "liq_list.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "liq_list.html";
$BlockToParse = "main";
