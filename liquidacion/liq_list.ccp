	...
	<Components>
		<Grid id="2" secured="False" sourceType="Table" returnValueType="Number" defaultPageSize="10" connection="Connection1" dataSource="fichas, propiedades, alquileres, fichaspropiedades" activeCollection="TableParameters" name="fichas_fichaspropiedades1" pageSizeLimit="100" wizardCaption=" Fichas,fichaspropiedades,propiedades Lista de" wizardGridType="Tabular" wizardSortingType="SimpleDir" wizardAllowInsert="False" wizardAltRecord="False" wizardAltRecordType="Style" wizardRecordSeparator="False" wizardNoRecords="No hay registros">
			...
			<JoinTables>
				...
				<JoinTable id="5" tableName="propiedades" schemaName="dbo" posLeft="158" posTop="189" posWidth="121" posHeight="180"/>
				<JoinTable id="41" tableName="alquileres" schemaName="dbo" posLeft="337" posTop="8" posWidth="158" posHeight="180"/>
				<JoinTable id="53" tableName="fichaspropiedades" schemaName="dbo" posLeft="458" posTop="231" posWidth="108" posHeight="104"/>
</JoinTables>
			<JoinLinks>
				...
				<JoinTable2 id="54" tableLeft="fichas" tableRight="fichaspropiedades" fieldLeft="fichas.idficha" fieldRight="fichaspropiedades.idficha" joinType="inner" conditionType="Equal"/>
<JoinTable2 id="55" tableLeft="propiedades" tableRight="fichaspropiedades" fieldLeft="propiedades.idpropiedad" fieldRight="fichaspropiedades.idpropiedad" joinType="inner" conditionType="Equal"/>
</JoinLinks>
			<Fields>
	...
	<CodeFiles>
		<CodeFile id="Code" language="PHPTemplates" name="liq_list.php" forShow="True" url="liq_list.php" comment="//" codePage="windows-1252"/>
	</CodeFiles>
	<SecurityGroups/>
	<CachingParameters/>
	<Attributes/>
