<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\liquidacionh" secured="False" urlType="Relative" isIncluded="False" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="SandBeach" wizardThemeVersion="3.0" needGeneration="0">
	<Components>
		...
		<Record id="3" sourceType="Table" urlType="Relative" secured="False" allowInsert="True" allowUpdate="True" allowDelete="True" validateData="True" preserveParameters="GET" returnValueType="Number" returnValueTypeForDelete="Number" returnValueTypeForInsert="Number" returnValueTypeForUpdate="Number" connection="Connection1" name="cuotas" dataSource="cuotas" errorSummator="Error" wizardCaption="Agregar/Editar Cuotas " wizardFormMethod="post" PathID="cuotas" returnPage="liquidacion.ccp" removeParameters="idcuota">
			<Components>
				...
				<Hidden id="15" fieldSourceType="DBColumn" dataType="Integer" name="idhipoteca" PathID="cuotasidhipoteca" fieldSource="idalquiler">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
