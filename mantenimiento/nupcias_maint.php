<?php
//Include Common Files @1-EC26B65C
define("RelativePath", "..");
define("PathToCurrentPage", "/mantenimiento/");
define("FileName", "nupcias_maint.php");
...
class clsRecordnupcias { //nupcias Class @2-449F668E
...
//Class_Initialize Event @2-09A9BAE1
    function clsRecordnupcias($RelativePath, & $Parent)
    {
        ...
        $this->ErrorBlock = "Record nupcias/Error";
...
//Operation Method @2-72AC41AF
    function Operation()
    {
        ...
        $Redirect = "nupcias_list.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
...
//DataSource Variables @2-7E55A41F
    var $Parent = "";
    var $CCSEvents = "";
    var $CCSEventResult;
    var $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-F5FEDBF5
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "nupcias_maint.html";
$BlockToParse = "main";
...
// Controls
$nupcias = & new clsRecordnupcias("", $MainPage);
...
//Execute Components @1-353B2834
$nupcias->Operation();
//End Execute Components

//Go to destination page @1-FEF3E548
if($Redirect)
{
